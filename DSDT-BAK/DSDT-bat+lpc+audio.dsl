 ...
 *
 * Disassembly of iASLmz9VVR.aml, Thu Mar 19 00:22:34 2020
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00011EDE (73438)
                    ...
                    Name (BUF0, ResourceTemplate()
{
                ...
                Device (EC)
                {
                    ...
                    Method (GBIF, 3, NotSerialized)
                    {
                        ...
                        If (Arg2)
                        {
                            ...
                            {
                                Divide (0x00030D40, B1B2(SDD1,SDD2), Local2, Index (Arg1, 0x06))
                            }
                            Else
                            {
                            ...
                            Store (B1B2(SDD1,SDD2), Index (Arg1, 0x04))
                            Store (B1B2(SBN1,SBN2), Local0)
                            ...
                            Store (B1B4(SCH0,SCH1,SCH2,SCH3), BTYP)
    ...
    Scope (\_GPE)
    {
        ...
        {
            Store (B1B2(\_SB.PCI0.LPC.EC.HAK1,\_SB.PCI0.LPC.EC.HAK2), Local0)
            Store (Local0, \RRBF)
            Sleep (0x0A)
            If (And (Local0, 0x02)){}
            If (And (Local0, 0x04))
